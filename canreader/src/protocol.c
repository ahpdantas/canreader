...
/**
 ...
 void SendMessage(CanRxMsgTypeDef* CanRxMsg)
 {
	 ...
	 AddFieldToBuffer((uint8_t *)CanRxMsg, sizeof(CanRxMsgTypeDef));
	 ...
	 AddEndByte();
	 HAL_UART_Transmit(&UartHandle,TrixlogProtocolBuffer , TrixlogProtocolMessageSize,100);
	 seq++;
